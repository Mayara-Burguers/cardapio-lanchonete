...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // --- Lógica de Renderização do Menu ---
    function renderizarMenu() {
        ...
        for (const nomeCategoria in categorias) {
            ...
            // Lógica para subcategorias (como em Pastéis)
    ...
    // --- Lógica de Interação e Eventos ---
    // (O restante do código para carrinho, cálculo de preço, whatsapp, etc., continua aqui)

    // Event listeners para navegação e botões
    ...
    // O restante do código de JS para o modal, carrinho e WhatsApp deve ser colado aqui.
    // Para simplificar, vou adicionar as funções essenciais que faltam.
    ...
    function renderizarCarrinho() {
        // Esta função deve ser implementada para mostrar os itens no carrinho lateral
        console.log("Renderizando carrinho...");
    }

    // --- Inicialização ---
    renderizarMenu();
    document.querySelector('#nav-categorias a').click(); // Ativa a primeira categoria
});
